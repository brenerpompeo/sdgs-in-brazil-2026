      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="about-intro grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-24">
          ...
          <div className="lg:col-span-6 p-8 sm:p-12 bg-white/[0.02] backdrop-blur-2xl rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.7)] flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="relative z-10 pt-8 mt-8 border-t border-white/10 flex items-center justify-between text-[11px] font-mono text-white/50">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-white/85 leading-relaxed font-light drop-shadow-sm">
                      {force.desc}
                    </p>
                  </div>

                  <div className="pt-4 border-t border-white/15 flex items-center justify-between text-[10px] font-mono text-white/60">
